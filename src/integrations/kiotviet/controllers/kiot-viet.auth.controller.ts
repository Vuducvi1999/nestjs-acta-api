...
import { KiotVietAuthService } from '../services/kiot-viet.auth.service';
import { ApiKeyValidationService } from '../../api-key-validation.service';

@ApiBearerAuth()
@ApiTags('KiotViet: Authentication')
@UseGuards(JwtAuthGuard)
@Controller('integrations/kiotviet/auth')
export class KiotVietAuthController {
  constructor(
