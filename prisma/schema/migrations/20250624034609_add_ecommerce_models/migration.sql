...
ALTER TYPE "ActivityType" ADD VALUE 'DOCUMENT_USER_FAVORITED';
ALTER TYPE "ActivityType" ADD VALUE 'DOCUMENT_USER_UNFAVORITED';
ALTER TYPE "ActivityType" ADD VALUE 'DOCUMENT_USER_VIEWED';
ALTER TYPE "ActivityType" ADD VALUE 'DOCUMENT_USER_DOWNLOADED';
ALTER TYPE "ActivityType" ADD VALUE 'DOCUMENT_USER_FOLLOWED';
ALTER TYPE "ActivityType" ADD VALUE 'DOCUMENT_USER_UNFOLLOWED';
ALTER TYPE "ActivityType" ADD VALUE 'DOCUMENT_USER_COMMENTED';
ALTER TYPE "ActivityType" ADD VALUE 'DOCUMENT_USER_COMMENT_LIKED';
ALTER TYPE "ActivityType" ADD VALUE 'DOCUMENT_USER_COMMENT_DELETED';
ALTER TYPE "ActivityType" ADD VALUE 'DOCUMENT_USER_COMMENT_EDITED';
ALTER TYPE "ActivityType" ADD VALUE 'DOCUMENT_USER_COMMENT_REPLIED';
ALTER TYPE "ActivityType" ADD VALUE 'DOCUMENT_CHAPTER_USER_COMPLETED';
ALTER TYPE "ActivityType" ADD VALUE 'DOCUMENT_CHAPTER_USER_UNCOMPLETED';
